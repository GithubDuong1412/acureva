...
class EcommerceHelper
{
    ...
    public function productFilterParamsValidated(Request $request): bool
    {
        ...
        $validator = Validator::make($input, [
            ...
            'collections' => ['nullable', 'array', 'sometimes'],
        ...
        $validator = Validator::make($request->input(), [
            ...
            'collections' => ['nullable', 'string', 'sometimes'],
    ...
    public function isEnabledFilterProductsByCollections(): bool
    {
        return (bool) get_ecommerce_setting('enable_filter_products_by_collections', true);
    }
    ...
    public function collectionsForFilter(array $categoryIds = []): Collection
    {
        if (! $this->isEnabledFilterProductsByCollections()) {
            return collect();
        }

        // Đảm bảo $categoryIds luôn là mảng
        ...
        return ProductCollection::query()
            ...
            ->withCount([
                'products as products_count' => function ($query) use ($categoryIds): void {
                    $query->where('status', BaseStatusEnum::PUBLISHED)
    ...
    public function dataForFilter(?ProductCategory $category, bool $currentCategoryOnly = false): array
    {
        ...
        if ($this->isEnabledFilterProductsByCollections()) {
            $collections = $this->collectionsForFilter($categoryIds ?? []);
        } else {
            $collections = collect(); // luôn trả về Collection rỗng
        }
    ...
    public function hasAnyProductFilters(): bool
    {
        return $this->isEnabledFilterProductsByCategories() ||
            ...
            $this->isEnabledFilterProductsByCollections() ||
