...
<html {!! Theme::htmlAttributes() !!}>
    ...
    <header class="header_wrap dk-header_wrap-custom @if (Theme::get('transparentHeader')) dd_dark_skin transparent_header @endif">
                        ...
                        <div class="col-md-6 col-left">
                            <div class="d-flex align-items-center justify-content-center justify-content-md-start">
                                ...
                                @if (theme_option('email'))
                                    <ul>
                                        <li>
                                            <i class="ti-email"></i><span><a href="mailto:{{ theme_option('email') }}">{{ theme_option('email') }}</a></span>
                                        </li>
                                    </ul>
                                @endif
                            </div>
                ...
                <div class="nav_block">
                    ...
                    <ul class="navbar-nav attr-nav align-items-center">
                        ...
                        @if (EcommerceHelper::isCartEnabled())
                            <li class="dropdown cart_dropdown"><a class="nav-link cart_trigger btn-shopping-cart" href="#" data-bs-toggle="dropdown"><i class="linearicons-cart"></i><span class="cart_count">{{ Cart::instance('cart')->count() }}</span></a>
