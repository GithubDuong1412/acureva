<div class="section pt-0 small_pb">
	<div class="container">
    	<div class="row">
        	<div class="col-12">
            	<div class="cat_overlap radius_all_5 dk-feature_categories">
                                        ...
                                        <div class="categories_box d-flex">
                                            <a href="{{ $category->url }}">
                                                @if ($icon = $category->getMetaData('icon', true))
                                                    <i class="{{ $icon }}"></i>
                                                @else
                                                    <img class="h-100 object-fit-cover" src="{{ RvMedia::getImageUrl($category->getMetaData('icon_image', true) ?: $category->image, null, false, RvMedia::getDefaultImage()) }}" alt="category-image" loading="lazy" />
                                                @endif
