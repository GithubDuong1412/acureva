                                        ...
                                        <div class="row g-0 align-items-center">
                                            <div class="col-lg-4 col-md-6 mb-3 mb-md-0">
                                                @if (!session()->has('applied_coupon_code'))
                                                    <div class="coupon field_form input-group form-coupon-wrapper g-4">
                                                        <input type="text" name="coupon_code" value="{{ old('coupon_code') }}" class="form-control coupon-code me-3" placeholder="{{ __('Enter Coupon Code...') }}">
                                                        <div class="input-group-append">
                                                            <button class="btn btn-fill-out btn-apply-coupon-code" type="button" data-url="{{ route('public.coupon.apply') }}">{{ __('Apply Coupon') }}</button>
                                                        </div>
                                                    </div>
                                                @endif
