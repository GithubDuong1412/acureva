                ...
                <?php if(!empty($product)): ?>
                    <li>
                        ...
                        <p style="margin-bottom: 0; line-height: 20px; color: #fff;">
                                 <small>Size: <?php echo e($cartItem->options['attributes']['size']); ?></small>
                                                        <small>Color: <?php echo e($cartItem->options['attributes']['color']); ?></small>      
                        </p>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\acureva\platform\themes/shopwise/partials/cart.blade.php ENDPATH**/ ?>